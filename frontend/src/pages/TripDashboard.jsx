              ...
              <div className="bg-white/90 backdrop-blur-xl p-6 sm:p-8 rounded-3xl shadow-[0_20px_50px_rgb(0,0,0,0.04)] border border-white/60">
                ...
                <ul className="mb-6 flex flex-wrap gap-2.5">
                  {members.map((m, index) => (
                    <li
                      key={m.id}
                      className="flex items-center gap-1.5 bg-indigo-50/50 border border-indigo-100 text-indigo-700 text-sm px-4 py-2 rounded-xl font-bold shadow-xs"
                    >
                      {/* Subtle Host Star Icon */}
                      {index === 0 && (
