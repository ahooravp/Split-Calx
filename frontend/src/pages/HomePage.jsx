...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 relative flex flex-col overflow-hidden transition-[background-color,border-color,box-shadow] duration-300 ease-in-out pt-16">
      ...
      <div className="px-6 lg:px-12 pt-14 md:pt-16 pb-24 md:pb-52 flex-grow relative z-10 flex items-center">        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed ">            Track group trip expenses, calculate precise debts, and settle up without the headache. No more spreadsheets, no more awkward conversations.
          </p>
