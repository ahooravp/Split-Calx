    ...
    <div className="relative h-[calc(100vh-65px)] bg-slate-50 flex items-center  justify-center p-4">
      ...
      <div className="max-w-md w-full relative z-10 fade-enter-active bg-white/90 backdrop-blur-xl p-8 rounded-3xl shadow-[0_20px_50px_rgb(0,0,0,0.08)] border border-white/60">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-teal-50 border border-teal-100 text-teal-600 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
            </svg>
          </div>
          <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight">Create Account</h2>
          <p className="text-sm text-slate-500 mt-2 font-medium">Join to start splitting bills effortlessly.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mb-6 space-y-4">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider">Create Password</label>
            <input 
              type="password" 
              placeholder="••••••••" 
              required 
